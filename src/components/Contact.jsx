...
function Contact() {
  ...
  return (
    ...
    <div name="Contact" className="bg-white dark:bg-black py-8 sm:py-12 md:py-16 w-full min-h-screen">
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        <h1 className='font-bold text-3xl sm:text-4xl text-center mb-6 sm:mb-10 text-gray-800 dark:text-white'>Contact Me</h1>
        <div className='max-w-xl sm:max-w-2xl md:max-w-3xl mx-auto'>
          <form onSubmit={onSubmitHandler} ref={form} className='bg-gray-50 dark:bg-gray-900 shadow-2xl rounded-lg p-4 sm:p-6 md:p-8 transition-all duration-300 hover:shadow-3xl'>
            <div className='mb-4 sm:mb-6'>
              <label className='block text-base sm:text-lg font-medium text-gray-700 dark:text-gray-200 mb-2'>Your Name*</label>
            ...
            <div className='mb-4 sm:mb-6'>
              <label className='block text-base sm:text-lg font-medium text-gray-700 dark:text-gray-200 mb-2'>Your Email*</label>
              <input 
                type="email" 
                placeholder='Email' 
                className='w-full px-3 sm:px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 dark:text-white text-sm sm:text-base' 
            ...
            <div className='mb-4 sm:mb-6'>
              <label className='block text-base sm:text-lg font-medium text-gray-700 dark:text-gray-200 mb-2'>Message</label>
              <textarea 
                name="textArea" 
