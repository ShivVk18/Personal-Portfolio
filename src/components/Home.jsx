...
function Home() {
  return (
    <div
      className="w-full min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 flex-col gap-6"
      name="Home"
    >
      <div className="text-center">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-4">
          Hi, I'm{" "}
          <span className="text-purple-500 font-bold">Shivansh Saxena</span>
        </h1>
        <TypeAnimation
          sequence={["Welcome To", 2000, "My Portfolio", 1000]}
          wrapper="div"
          cursor={true}
          repeat={Infinity}
