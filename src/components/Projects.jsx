...
function Projects(props) {
  ...
  return (
    <div name="Projects" className='mt-10 py-12 sm:py-16 md:py-20 bg-white dark:bg-black w-full min-h-screen'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        <h1 className='text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12 text-gray-800 dark:text-white'>My Projects</h1>
